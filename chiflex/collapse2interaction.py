...
#for iid, intervals in iid2intervals.iteritems():
	#print "_"*140
	#print iid
	#print
...
#print set([len(x) % 2 for x in iid2intervals.values()])
		
#iid2cid = defaultdict(list)
#for cid, iids in cid2iid.iteritems():
	#iid2cid[tuple(sorted(iids))].append(cid);