...
parser.add_argument('--output', nargs = '?', required = True, type = str, help = "Path for the filtered sam/bam file");
...
signal = filter_generator(ss, args.features);
control = filter_generator(sc, args.features);
