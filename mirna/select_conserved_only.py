...
parser.add_argument('--species', nargs = '+', default = [], type = str, help = "miRNA is selected if it is conserved among [species]. If not set, this filter does not apply. Specie should follow mirBase names [hsa, mmu, cel]");
