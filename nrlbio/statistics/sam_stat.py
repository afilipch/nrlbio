...
if(args.short_reference):
	...
	headers.append("Start position of the match in query and reference")
	headers.append("Start position of the match in reference")
	headers.append("End position of the match in reference")
